...
**YOU ARE IN: `stardust/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/stardust/` (rig root) or other directories
...
**Your mail address:** `stardust/polecats/obsidian`
**Your rig:** stardust
**Your Witness:** `stardust/witness`
...
| Ask Witness for help | `gt mail send stardust/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`stardust/witness`) when:
...
```bash
gt mail send stardust/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
